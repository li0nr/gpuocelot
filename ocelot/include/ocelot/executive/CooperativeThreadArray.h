...
namespace executive {
	...
	public:
		...
		void eval_Bmsk(CTAContext &context, const ir::PTXInstruction &instr);
		...
		void eval_Fns(CTAContext &context, const ir::PTXInstruction &instr);
		...
		void eval_Tanh(CTAContext &context, const ir::PTXInstruction &instr);
